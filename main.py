...
def museum():
	video_map = {
		...
		"k7_LgEGGTwo": ["Interview Podcast", "This project was made for the interview podcast project in ENGCMP 610 during sophomore year. I didn't want to grab someone else to interview, so I talked to myself in the Whisper Room. The gimmick played off well for me!"],
